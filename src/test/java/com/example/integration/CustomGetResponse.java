 ...
 */
@Stability.Internal
public final class CustomGetResponse extends KeyValueBaseResponse {
  ...
  public CustomGetResponse(final String key, final ResponseStatus status, final byte[] content, final long cas, final int flags) {
    super(status);
